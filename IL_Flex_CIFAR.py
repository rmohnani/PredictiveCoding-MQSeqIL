...
class IL(nn.Module):
    def __init__(self, output_dim=10, lr=.001, type=0, n_iter=25, gamma=.05, alpha=0, lr_min=.001, r=.000001, decay=False, beta=100
                 , initial_channels = 32):
        super().__init__()
        ...
        print("Iterative updates:", self.n_iter)
